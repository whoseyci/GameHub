...
// The last 3 params train the strategic question: when a very low card is drawn,
// should we spend it on an unrevealed slot instead of polishing a known card?
import fs from 'fs';
...
const DIM=15;
const INIT=[3,3,2,5,3,1.5,0.6,4,1.0,2,0.35,7,0,4.5,1.5];
const PROD_PARAMS={
